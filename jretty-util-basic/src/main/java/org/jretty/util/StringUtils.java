...
public class StringUtils {
    ...
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
    // String EqualIgnoreCase 忽略英文大小写 相关算法工具
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
     ...
     * "https://z.cn/" ==> https://z.cn
     * "http://z.cn/app" ==> http://z.cn/app
     * "http://z.cn/app/" ==> http://z.cn/app
     * "http://z.cn/app/xxxx" ==> http://z.cn/app
     * }</pre>
     * @return baseUrl like http://z.cn/app
     */
    public static String baseUrl(String url) {
        if (url != null) {
            String[] ss = StringSplitUtils.splitNolastEmpty(url, '/');
            if (ss.length > 3) {
                return ss[0] + "//" + ss[2] + "/" + ss[3];
            } else if (ss.length == 3) {
                return ss[0] + "//" + ss[2];
            }
        }
    ...
    /**
     * 裁剪字符串，用于超长文本精简信息输出。
     * 最多只取 maxLen 个字符(maxLen>=20)，规则如下： <br>
    ...
    public static String changeEncode(final String str, final String newCharset) {
        ...
        try {
            // ISO-8859-1
            String iso = new String(str.getBytes(newCharset), Const.ISO_8859_1);
    ...
    /**
     * @see #replaceParams(Object, Object...) 
     */
     ...
     * @deprecated pls use ArrayUtils.toString
     * 
     */
