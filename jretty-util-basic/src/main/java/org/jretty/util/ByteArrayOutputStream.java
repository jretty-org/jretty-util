...
import org.jretty.util.support.ClosedInputStream;
...
public class ByteArrayOutputStream extends OutputStream {
    ...
    public synchronized int write(final InputStream in, int len) throws IOException {
        int readCount = 0;
        int inBufferPos = count - filledBufferSum;
        int n = in.read(currentBuffer, inBufferPos, currentBuffer.length - inBufferPos);
        while (n != IOUtils.EOF) {
    ...
    public String toString(final String charSet) throws UnsupportedEncodingException {
        return new String(toByteArray(), StringUtils.decideCharSet(charSet));
    }
