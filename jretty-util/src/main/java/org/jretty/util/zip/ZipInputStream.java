...
class ZipInputStream extends InflaterInputStream implements ZipConstants {
    ...
    public int read(byte[] b, int off, int len) throws IOException {
        ...
        case STORED:
            ...
            if (remaining == 0 && entry.crc != crc.getValue()) {
                throw new ZipException("invalid entry CRC (expected 0x" + Long.toHexString(entry.crc) + " but got 0x"
    ...
    private ZipEntry readLOC() throws IOException {
        ...
        readFully(b, 0, len);
        ZipEntry e = createZipEntry(charset == null ? getUTF8String(b, 0, len) : new String(b, 0, len, charset));
        // createZipEntry(getUTF8String(b,0,len));
    ...
    /*
     * Fetches unsigned 16-bit value from byte array at specified offset. The bytes are assumed to be in Intel
    ...
    /*
     * Fetches unsigned 32-bit value from byte array at specified offset. The bytes are assumed to be in Intel
     * (little-endian) byte order.
     */
