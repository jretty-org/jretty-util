...
public class NestedCheckedException extends BasicCheckedException implements NestedException, ExceptionDelegateSupport {
    ...
    private final NestedExceptionDelegate delegate;//<NestedCheckedException>
    ...
    public NestedCheckedException(String message, String... args) {
        this.exception = null;
        this.delegate = new NestedExceptionDelegate(null, message, args);//NestedCheckedException.class, 
    }
